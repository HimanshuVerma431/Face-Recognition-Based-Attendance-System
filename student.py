...
# ================= variables ========================
        ...
        self.var_teacher=StringVar()
          ...
          ## first image
        img=Image.open(r"F:\aaaaaa\face-recognition-python-code\college_images\pexels-cátia-matos-1072179.jpg")
        ...
        ## Second image
        img1=Image.open(r"F:\aaaaaa\face-recognition-python-code\college_images\facialrecognition.png")
        ...
        ## Third Image
        img2=Image.open(r"F:\aaaaaa\face-recognition-python-code\college_images\pexels-cátia-matos-1072179.jpg")
        ...
        ## bg image
        img3=Image.open(r"F:\aaaaaa\face-recognition-python-code\college_images\pexels-pixabay-247671.jpg")
        ...
        bg_img.place(x=0,y=130,width=1530,height=710) 
         ...
         ## title
        title_lbl=Label(bg_img,text="STUDENT ATTENDANCE SYSTEM",font=('times new roman',35,'bold'),bg="black",fg="red")
        ...
        img_left=Image.open(r"f:\aaaaaa\face-recognition-python-code\college_images\AdobeStock_303989091.jpeg")
        ...
        current_course_frame.place(x=5,y=135,width=718,height=115)
        ...
        class_student_frame.place(x=5,y=250,width=718,height=300)
        ...
        ## Class Division
        division_label=Label(class_student_frame,text="Class Division",font=("times new roman",12,"bold")) 
        ...
        img_right=Image.open(r"F:\aaaaaa\face-recognition-python-code\college_images\Team-Management-Software-Development.jpg")
        ...
        search_combo=ttk.Combobox(Search_frame,font=("times new roman",13,"bold"),width=17)
        ...
        search_btn=Button(Search_frame,text="Search",width=10,font=("times new roman",13,"bold"))
        search_btn.grid(row=0,column=3)
        
        showAll_btn=Button(Search_frame,text="Show All",width=10,font=("times new roman",13,"bold"))
        showAll_btn.grid(row=0,column=4)
        
        ## =================== table frame ===================
        
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=210,width=708,height=350)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="hunny@123",database="face_recognition")
                ...
                self.fetch_data()
                conn.close() 
                messagebox.showinfo("Success","Student Details has been addedSuccesfully",parent=self.root)
...
## =============== get cursor ================
        ...
        if self.var_dep.get()=="Select Department" or self.var_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    ...
                    if not Upadate:
                        return
                messagebox.showinfo("Success","Student Detail Succcussfully updated",parent=self.root)
                conn.commit()
                self.fetch_data()
                conn.close()
    ...
    # ================== Generate data set or take phot samples=============
