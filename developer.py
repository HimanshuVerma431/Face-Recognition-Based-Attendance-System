...
class Develpoer:
    def __init__(self,root):
        ...
        img_top1=Image.open(r"college_images\himanshu.jpg")
        ...
        # Developer info 
        dev_label=Label(main_frame,text="Hello My name is Himanshu !!",font=("times new roman",15,"bold"),) 
        dev_label.place(x=0,y=5)
        
        dev_label=Label(main_frame,text="I am AI Developer",font=("times new roman",15,"bold"),) 
