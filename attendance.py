...
class Attendance:
    def __init__(self,root):
        ...
        ## bg image
        img3=Image.open(r"college_images\pexels-pixabay-247671.jpg")
        ...
        ## Attendance ID
        attendancdeId_label=Label(left_inside_frame,text="AttendanceID",font=("times new roman",12,"bold")) 
        attendancdeId_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
